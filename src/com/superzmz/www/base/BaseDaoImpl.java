...
public abstract class BaseDaoImpl<T> implements BaseDao<T> {
    ...
    public PageBean getATCPageBean(int currentPage, int pageSize,int count,List<User> userList) {
        count = userList.size();
        return new PageBean(currentPage, pageSize, count, userList);
    }

    public PageBean getTCPageBean(int currentPage, int pageSize,int count,List<Timecard> timecardList) {
        count = timecardList.size();
        return new PageBean(currentPage, pageSize, count, timecardList);
    }
}
