            ...
            <section class="panel">
                ...
                <div class="panel-body">
                    <table class="table table-hover general-table">
                        ...
                        <c:if test="${fn:length(allScheduleList ) == 0 }">
                            <tr style="text-align: center">
                                <td colspan="6">暂无申请</td>
                            </tr>
                        </c:if>

                        <c:forEach var="allSchedule" items="${allScheduleList }">
                            <tr>
                                <td class="hidden-phone hidden-xs">${allSchedule.createTime}</td>
                                <td>${allSchedule.days }天 </td>
                                <td>  <span class="label label-success label-mini">正常</span>  </td>
                                <td> <span class="label label-warning label-mini">${allSchedule.result==2?"未完成":(allSchedule.result==1?"完成":"处理中")}</span>  </td>
                                ...
                                <td>  <a href="scheduleDetail.action?scheduleId=${allSchedule.id }"> 查看 </a>  </td>
                            </tr>
                        </c:forEach>
